...
export default function SentryUsersPage() {
  ...
  const setUserStatus = useMutation(api.superadmin.users.setStatus);
  const setPlatformRole = useMutation(api.superadmin.users.setPlatformRole);
                    ...
                    <TableCell className="text-right">
                      <DropdownMenu>
                        <DropdownMenuTrigger
                          ...
                          className="inline-flex size-7 items-center justify-center rounded-md outline-none transition-colors hover:bg-muted focus-visible:ring-2 focus-visible:ring-ring/50"
                        >
